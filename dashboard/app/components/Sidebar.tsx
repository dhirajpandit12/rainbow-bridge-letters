...
export default function Sidebar({ active, onNavigate }: { active?: 'rainbow' | 'soul'; onNavigate?: (t: 'rainbow' | 'soul') => void }) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 shrink-0 border-r border-stone-200 bg-white h-screen sticky top-0">
      <div className="px-5 py-6 border-b border-stone-100 flex flex-col items-center text-center">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/logo.png" alt="Heal Your Inner Peace" className="h-9 w-auto" />
        <p className="text-[11px] text-stone-400 mt-2.5 uppercase tracking-wider font-medium">Pets Reading Admin</p>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        ...
        <div className="pt-4 mt-4 border-t border-stone-100">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm font-semibold bg-stone-100 text-stone-700 hover:bg-stone-200 transition-colors"
          >
